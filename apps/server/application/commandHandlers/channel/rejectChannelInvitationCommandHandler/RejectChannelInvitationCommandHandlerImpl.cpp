...
{
    LOG_S(INFO) << fmt::format("Rejecting channel invitation... {{recipientId: {}, channelInvitationId: {}}}",
    ...
    LOG_S(INFO) << fmt::format("Channel invitation rejected. {{channelInvitationId: {}}}", channelInvitation->getId());
}
}
